...
OPTIONAL MATCH p=(center)-[:SOCIO_DE|DOOU|CANDIDATO_EM|VENCEU|CONTRATOU|ADJUDICOU_A|AUTOR_EMENDA|SANCIONADA|OPERA_UNIDADE|DEVE|RECEBEU_EMPRESTIMO|EMBARGADA|MANTEDORA_DE|BENEFICIOU|GEROU_CONVENIO|SAME_AS|POSSIBLE_SAME_AS|OFFICER_OF|FORNECEU_LICITACAO|LICITOU|DECLAROU_BEM|DECLAROU_FINANCA|RECEBEU_SALARIO|REFERENTE_A|ADMINISTRA*1..4]-(connected)
