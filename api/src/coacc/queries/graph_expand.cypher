...
CALL apoc.path.expandConfig(
  center,
  {
    relationshipFilter: "SOCIO_DE|DONO_A|CANDIDATO_EM|GANO|CONTRATOU|ADJUDICOU_A|AUTOR_EMENDA|SANCIONADA|OPERA_UNIDAD|DEVE|RECEBEU_EMPRESTIMO|EMBARGADA|MANTIENE_A|BENEFICIO|GENERO_CONVENIO|SAME_AS|POSSIBLY_SAME_AS|OFFICER_OF|INTERMEDIARY_OF|GLOBAL_PEP_MATCH|CVM_SANCIONADA|GASTO|SUMINISTRO|SUMINISTRO_LICITACAO|LICITO|DECLARO_BIEN|DECLARO_FINANZAS|RECIBIO_SALARIO|REFERENTE_A|ADMINISTRA",
