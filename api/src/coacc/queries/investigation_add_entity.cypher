...
RETURN i.id AS investigation_id,
       coalesce(e.document_id, e.nit, e.cedula, e.numero_documento, e.partner_id, e.contract_id, e.sanction_id, e.amendment_id, e.finance_id, e.embargo_id, e.school_id, e.convenio_id, e.stats_id, e.bid_id, e.asset_id, e.office_id, elementId(e)) AS entity_id
