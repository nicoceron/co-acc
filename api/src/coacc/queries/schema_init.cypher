...
CREATE INDEX bid_portfolio_id IF NOT EXISTS
  FOR (b:Bid) ON (b.portfolio_id);
...
CREATE INDEX declared_asset_publication_date IF NOT EXISTS
  FOR (d:DeclaredAsset) ON (d.publication_date);
...
CREATE FULLTEXT INDEX entity_search IF NOT EXISTS
  FOR (n:Person|Partner|Company|Contract|Bid|Sanction|Election|Amendment|Finance|DeclaredAsset|Health|Education|Convenio|Embargo|PublicOffice|Inquiry|InquiryRequirement|MunicipalContract|MunicipalBid|MunicipalGazetteAct|JudicialCase|SourceDocument)
  ON EACH [n.name, n.razao_social, n.document_id, n.nit, n.cedula, n.numero_documento, n.cpf, n.cnpj, n.doc_partial, n.doc_raw, n.cnes_code, n.object, n.contracting_org, n.convenente, n.infraction, n.org, n.function, n.subject, n.text, n.topic, n.case_number, n.url, n.reference, n.bid_id, n.asset_id, n.office_id, n.finance_id, n.election_id];
