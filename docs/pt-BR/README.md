...
[![WTG Header](../brand/coacc-header.jpg)](../brand/coacc-header.jpg)
...
[![CI](https://github.com/World-Open-Graph/co-acc/actions/workflows/ci.yml/badge.svg)](https://github.com/World-Open-Graph/co-acc/actions/workflows/ci.yml)
[![License: AGPL v3](https://img.shields.io/badge/License-AGPL_v3-blue.svg)](https://www.gnu.org/licenses/agpl-3.0)
[![Last Commit](https://img.shields.io/github/last-commit/World-Open-Graph/co-acc)](https://github.com/World-Open-Graph/co-acc/commits)
[![Issues](https://img.shields.io/github/issues/World-Open-Graph/co-acc)](https://github.com/World-Open-Graph/co-acc/issues)
[![Stars](https://img.shields.io/github/stars/World-Open-Graph/co-acc?style=social)](https://github.com/World-Open-Graph/co-acc/stargazers)
[![Forks](https://img.shields.io/github/forks/World-Open-Graph/co-acc?style=social)](https://github.com/World-Open-Graph/co-acc/network/members)
...
[Discord](https://discord.gg/YyvGGgNGVD) | [Twitter](https://x.com/brunoclz) | [Website](https://coacc.org) | [Contribuir](#contribuindo)

---

## O que e co/acc?

co/acc e um movimento descentralizado de builders brasileiros usando tecnologia e dados abertos para tornar informacao publica mais acessivel. Este repositorio e um de seus projetos: uma infraestrutura open-source em grafo que ingere bases de dados publicas brasileiras oficiais — registros de empresas, saude, educacao, emprego, financas publicas, licitacoes, meio ambiente — e normaliza tudo em um unico grafo consultavel.
...
[Saiba mais em coacc.org](https://coacc.org)

---

## Funcionalidades

- **45 modulos ETL implementados** — status rastreado em `docs/source_registry_co_v1.csv` (loaded/partial/stale/blocked/not_built)
...
- Fluxo BYO-data via pipelines `coacc-etl`.
...
- **Website**: [coacc.org](https://coacc.org)
...
- [Historico de releases](https://github.com/World-Open-Graph/co-acc/releases)
