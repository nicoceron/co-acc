...
`phase11-local-20260605-bpin-priority-work` run:

- Materialized parquet: 163,479 `signal_hits` rows and 282,766
...
The production public catalog currently exposes the 17 public materialized
