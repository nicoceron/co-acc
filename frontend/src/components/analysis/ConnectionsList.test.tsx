...
const nodes: GraphNode[] = [
  { id: "center", label: "Center", type: "person", properties: {}, sources: [{ database: "SIGEP" }] },
  { id: "n1", label: "Company A", type: "company", properties: {}, sources: [{ database: "SECOP Integrado" }] },
  { id: "n2", label: "Company B", type: "company", properties: {}, sources: [{ database: "SECOP Integrado" }] },
  { id: "n3", label: "Person B", type: "person", properties: {}, sources: [{ database: "SIGEP" }] },
];
