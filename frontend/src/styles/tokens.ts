...
export const relationshipColors: Record<string, string> = {
  ...
  AUTOR_EMENDA: "#E0E0E0",
  SANCIONADA: "#D05050",
  OPERA_UNIDADE: "#D8508A",
  DEVE: "#4A80D0",
  RECEBEU_EMPRESTIMO: "#4A80D0",
  EMBARGADA: "#D87530",
  MANTEDORA_DE: "#9560D8",
  BENEFICIOU: "#3FB0A0",
  GEROU_CONVENIO: "#3FB0A0",
  SAME_AS: "#607080",
  ...
  EXPULSO: "#C04040",
  FIRMOU_LENIENCIA: "#209060",
  HOLDING_DE: "#D08570",
  GASTOU_CARTAO: "#D0A030",
  VIAJOU: "#20A090",
  LICITOU: "#8060E0",
  ADMINISTRA: "#2080B8",
  GERE: "#2080B8",
  PUBLICOU: "#807870",
  MENCIONOU: "#807870",
  RECEBEU_RENUNCIA: "#C84078",
  DECLAROU_FINANCA: "#208880",
  FORNECEU_LICITACAO: "#8060E0",
  RECEBEU_SALARIO: "#208078",
  REFERENTE_A: "#784AE0",
  DECLAROU_BEM: "#784AE0",
  FILIADO_A: "#209060",
  IMPEDIDA: "#A83060",
